...
public class DrawnTarget extends Drawable {
  ...
  public void CheckObjects() {
	  if(t.getObject()==null) {
		  ...
		  try {
			setImg(ImageIO.read(new File("pics/Crate_on_Target.png")));// kép beolvasása
		} catch (IOException e) {
			e.printStackTrace();
		}
		  setImg_label(new JLabel(new ImageIcon(getImg()))); // így már egy komponens és majd hozzá tudjuk adni a mapPanel-hez
		  ...
		  case "w1":
			  try {
				setImg(ImageIO.read(new File("pics/Worker_1_on_Target.png")));
			} catch (IOException e) {
				e.printStackTrace();
			}// kép beolvasása
			  setImg_label(new JLabel(new ImageIcon(getImg()))); // így már egy komponens és majd hozzá tudjuk adni a mapPanel-hez
		  ...
		  case "w2":
			  try {
				setImg(ImageIO.read(new File("pics/Worker_2_on_Target.png")));
			} catch (IOException e) {
				e.printStackTrace();
			}// kép beolvasása
			  setImg_label(new JLabel(new ImageIcon(getImg()))); // így már egy komponens és majd hozzá tudjuk adni a mapPanel-hez
		  ...
		  case "w3":
			  try {
				setImg(ImageIO.read(new File("pics/Worker_3_on_Target.png")));
			} catch (IOException e) {
				e.printStackTrace();
			}// kép beolvasása
			  setImg_label(new JLabel(new ImageIcon(getImg()))); // így már egy komponens és majd hozzá tudjuk adni a mapPanel-hez
		  ...
		  case "w4":
			  try {
				setImg(ImageIO.read(new File("pics/Worker_4_on_Target.png")));
			} catch (IOException e) {
				e.printStackTrace();
			}// kép beolvasása
			  setImg_label(new JLabel(new ImageIcon(getImg()))); // így már egy komponens és majd hozzá tudjuk adni a mapPanel-hez
